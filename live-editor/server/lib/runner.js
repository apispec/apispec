...
function run(emit, opts) {
    const cfg = path.resolve('.mocharc.json');
    console.log(cfg);
    ...
    const options = {
        ...
        reporterOptions: {
            ...
            saveJson: false,
            saveHtml: "false",
            htmlModule: "@apispec/html-report"
        }
    };

    console.log('@apispec/runner v%s (grep: %s) %s', '???', options.grep, JSON.stringify(options));
    console.log('---------------');
...
*/
    ...
    fs.access(testDir, fs.R_OK, (err) => {
        if (err) {
            ...
            klawSync(testDir, { nodir: true, filter: ({ path }) => path.substr(-3) === '.js' }).forEach(({ path }) => {
                // TODO: delete hooks in barista-package
...
var initialReportState = {
        ...
        "suites": [
            {
                ...
                "tests": [
                    {
                        "title": "should either redirect to manager or show firstrun start page",
                        "fullTitle": "Firstrun Form should either redirect to manager or show firstrun start page",
                        "timedOut": false,
                        "duration": 22,
                        "state": "passed",
                        "speed": "fast",
                ...
                "fullFile": "/home/zahnen/development/mocha4web/testxp/admin/spec_users.js",
                "passes": [
                    {
                        "title": "should either redirect to manager or show firstrun start page",
                        "fullTitle": "XtraProxy E2E Tests v0.1.0 Firstrun Form should either redirect to manager or show firstrun start page",
                        "timedOut": false,
                        "duration": 22,
                        "state": "passed",
                        "speed": "fast",
                ...
                "tests": [
                    {
                        ...
                        "fullTitle": "XtraProxy E2E Tests v0.1.0 Authentication Form should contain auth state",
                        "timedOut": false,
                        "duration": 43,
                        "state": "passed",
                        "speed": "medium",
                    ...
                    },
                    {
                        ...
                        "err": {
                            "name": "AssertionError",
                            "message": "expected redirect with 30{1-3} status code but got 200",
                            "stack": "AssertionError: expected redirect <span class=\"hljs-keyword\">with</span> <span class=\"hljs-number\">30</span>{<span class=\"hljs-number\">1</span>-<span class=\"hljs-number\">3</span>} status code but got <span class=\"hljs-number\">200</span><br>    at testxp/auth/spec_auth.js:<span class=\"hljs-number\">64</span>:<span class=\"hljs-number\">36</span><br>    at mocha-chai.js:<span class=\"hljs-number\">89</span>:<span class=\"hljs-number\">21</span>"
                        },
                        "isRoot": false,
                        "uuid": "a9cf27c7-fe47-4e17-9d6d-1214403fc4ae",
                        "parentUUID": "ac98de6f-d881-42de-96d5-c72c8da5b6ee",
                        "requests": "POST /rest/auth/authorize/ HTTP/1.1<br>Host: localhost:7080<br>Accept-Encoding: gzip, deflate<br>User-Agent: node-superagent/2.3.0<br>Content-Type: application/x-www-form-urlencoded<br>Content-Length: 81<br>Connection: close<br>AUTH_STATE=e9ff673e-a8ba-4a36-941e-0f2f79ef8067&amp;j_username=admin&amp;j_password=admin<br>HTTP/1.1 200<br>date: Mon, 14 Nov 2016 18:32:16 GMT<br>content-type: text/html<br>connection: close<br><span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">!DOCTPYE</span> <span class=\"hljs-attribute\">html</span>&gt;</span><br><span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">head</span>&gt;</span><br>    <span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">meta</span> <span class=\"hljs-attribute\">charset</span>=<span class=\"hljs-value\">\"UTF-8\"</span> /&gt;</span><br>    <span class=\"hljs-tag\">&lt;<span class=\"hljs-title\">meta</span> <span class=\"hljs-attribute\">http-equiv</span>=<span class=\"hljs-value\">\"X-UA-Compatible\"</span> <span class=\"hljs-attribute\">cont</span></span>",
                        "skipped": false
                    },
                    {
                        "title": "should show error message for invalid login",
                        "fullTitle": "XtraProxy E2E Tests v0.1.0 Authentication Form should show error message for invalid login",
                        "timedOut": false,
                        "duration": 0,
                        "pass": false,
                        "fail": false,
            ...
            },
            {
                ...
                "tests": [
                    ...
                    },
                    {
                        ...
                        "fullTitle": "XtraProxy E2E Tests v0.1.0 User Management should have empty group list",
                        "timedOut": false,
                        "duration": 0,
                        "pass": false,
                        "fail": false,
                        "pending": true,
                        "code": "<span class=\"hljs-keyword\">return</span> request(e2e_mocha.parameters.url)<br>    .get(<span class=\"hljs-string\">'/rest/admin/groups/'</span>)<br>    .buffer()<br>    .then(<span class=\"hljs-function\"><span class=\"hljs-keyword\">function</span>(<span class=\"hljs-params\">response</span>) </span>{<br>        response.should.have.status2(<span class=\"hljs-number\">500</span>);<br>        response.should.have.mime(<span class=\"hljs-string\">'application/json'</span>);<br>    })",
                        "isRoot": false,
    ...
    "allTests": [
        ...
        {
            "title": "should redirect with token for valid login",
            "fullTitle": "Authentication Form should redirect with token for valid login",
            "timedOut": false,
            "duration": 36,
            "state": "failed",
            "pass": false,
        ...
        {
            "title": "should show error message for invalid login",
            "fullTitle": "Authentication Form should show error message for invalid login",
            "timedOut": false,
            "duration": 0,
            "pass": false,
            "fail": false,
    ...
    "allPending": [
        {
            ...
            "pending": true,
            "type": "test",
            "file": "/home/zahnen/development/mocha4web/testxp/admin/spec_users.js",
            "parent": {
                "title": "Firstrun Form",
                "suites": [],
                "tests": [
                ...
                "_runnable": {
                    ...
                    "err": {
                        ...
                        "actual": {
                            "req": {
                                "method": "post",
                                "url": "http://localhost:7080/rest/auth/authorize/",
                                "data": "AUTH_STATE=e9ff673e-a8ba-4a36-941e-0f2f79ef8067&j_username=admin&j_password=admin",
                                "headers": {
