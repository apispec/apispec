import { extendObservable, observable, action, autorun, configure } from 'mobx';
    ...
    constructor(data = {}, config = {}) {
        ...
        extendObservable(
            this,
            {
                ...
                isLoading: true,
                showFailed:
                    config.showFailed !== undefined ? config.showFailed : true,
                showHooks: this._getShowHooks(config),
                showPassed:
                    config.showPassed !== undefined ? config.showPassed : true,
                showPending:
                    config.showPending !== undefined
                        ? config.showPending
                        : true,
                showSkipped:
                    config.showSkipped !== undefined
                        ? config.showSkipped
                        : false,
                sideNavOpen: false,
            },
