...
function createSpec(name, version, verbose, addJsonAsserts, useLocalApispec) {
    const root = path.resolve(name);
    const appName = path.basename(root);

    checkAppName(appName);
    fs.ensureDirSync(name);
    fs.ensureDirSync(path.resolve(name, 'spec'));
    ...
    const packageJson = {
        ...
        scripts: {
            ...
            //TODO
            postinstall:
                'patch-package --patch-dir ./node_modules/@apispec/core/patches',
        },
        dependencies: {
